...
/** Derived from the provider registry, never re-listed: adding a provider to PROVIDERS widens this
 *  automatically, and removing one makes every stale reference a compile error. */
